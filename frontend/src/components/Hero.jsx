        ...
        <div className="lg:grid lg:grid-cols-12 lg:min-h-[90vh] items-center">
          ...
          <div className="lg:col-span-6 px-4 sm:px-6 lg:px-8 py-20 lg:py-0">
            ...
            <p className="mt-8 text-lg text-gray-500 leading-relaxed max-w-lg">
              The SevenPetal Scholarship Program provides full financial support, mentorship, and opportunity to students from <strong className="text-gray-700">+2 through PhD</strong> — across all 77 districts of Nepal.
            </p>
